...
export const bookingsAPI = {
  ...
  // FIX: cancellation is a state change (PATCH), not a deletion (DELETE)
...
export const paymentsAPI = {
  /**
   * Submit payment reference + optional screenshot (multipart/form-data).
   * @param {string} bookingId
   * @param {string} referenceNumber
   * @param {File|null} proofImage
   */
